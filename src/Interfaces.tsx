...
export const categoryItem: CategoryItem[] = [
    ...
    { id: 1, value: 'Zmiana Produktu', single: 0 },
    { id: 1, value: 'Zmiana Asortymentu', single: 0 },
    { id: 2, value: 'Praca', single: 0 },
    { id: 3, value: 'Awaria', single: 3 },
    { id: 4, value: 'Przerwa', single: 1 },
    { id: 5, value: 'Silosy', single: 0 },
    { id: 6, value: 'Zbiorniki Mikro', single: 0 },
    { id: 7, value: 'Podajnik Worków', single: 0 },
    { id: 8, value: 'Adams', single: 0 },
    { id: 9, value: 'Taśmy', single: 0 },
    { id: 10, value: 'EtyieCiarka', single: 0 },
    { id: 11, value: 'Drukarka', single: 0 },
    { id: 12, value: 'Paletpac', single: 0 },
    { id: 13, value: 'Strech-Hord', single: 0 },
    { id: 14, value: 'Brak Zasypu', single: 0 },
    { id: 15, value: 'Mieszalnik', single: 0 },
    { id: 16, value: 'Kosz Podmieszarkowy', single: 0 },
    { id: 17, value: 'Hangar', single: 0 },
    { id: 18, value: 'Radimat', single: 0 },
    { id: 19, value: 'Taśmociąg', single: 0 },
    { id: 20, value: 'Drukarka', single: 0 },
    { id: 21, value: 'Robot', single: 0 },
    { id: 22, value: 'Podajnik Palet', single: 0 },
    { id: 23, value: 'Rolotoki', single: 0 },
    { id: 1000, value: 'Inne', single: 0 },
];
