...
export const categoryAwaria: CategoryAwaria[] = [
    ...
    { id: 6, value: 'Zbiorniki Mikro', single: 0, parent: -1 },
    { id: 7, value: 'Podajnik Worków', single: 0, parent: -1 },
    { id: 8, value: 'Adams', single: 0, parent: -1 },
    { id: 9, value: 'Taśmy', single: 0, parent: -1 },
    { id: 10, value: 'EtyieCiarka', single: 0, parent: -1 },
    { id: 11, value: 'Drukarka', single: 0, parent: -1 },
    { id: 12, value: 'Paletpac', single: 0, parent: -1 },
    { id: 13, value: 'Strech-Hord', single: 0, parent: -1 },
    { id: 14, value: 'Brak Zasypu', single: 0, parent: -1 },
    { id: 15, value: 'Mieszalnik', single: 0, parent: -1 },
    { id: 16, value: 'Kosz Podmieszarkowy', single: 0, parent: -1 },
    { id: 17, value: 'Hangar', single: 0, parent: -1 },
    { id: 18, value: 'Radimat', single: 0, parent: -1 },
    { id: 19, value: 'Taśmociąg', single: 0, parent: -1 },
    { id: 20, value: 'Drukarka', single: 0, parent: -1 },
    { id: 21, value: 'Robot', single: 0, parent: -1 },
